...
def map_working(request):
    PlaceLocations = Works_Places.objects.values('WorkPlace_id', 'ReasonForPlace', 'Objects_Name__Work_Name', 'Objects_Name__Description', 'Objects_Name__Author__Author_Name', 'Objects_Name__AuthorAttributionCertainty', 'Objects_Name__Work_Creation_date', 'Main_Work_Image__Image_Name', 'Main_Work_Image__ImageAuthor_Name__Author_Name', 'Main_Work_Image__stable_url', 'Places_Name__Map_Place_Name', 'Places_Name__Latitude', 'Places_Name__Longitude').filter(ReasonForPlace='Artist')
    return render_to_csv_response(PlaceLocations)

def map_working_drawingphoto(request):
    PlaceLocationDrawingPhoto = Works_Places.objects.values('WorkPlace_id', 'ReasonForPlace', 'Objects_Name__Work_Name', 'Objects_Name__Description', 'Objects_Name__Author__Author_Name', 'Objects_Name__AuthorAttributionCertainty', 'Objects_Name__Work_Creation_date', 'Main_Work_Image__Image_Name', 'Main_Work_Image__ImageAuthor_Name__Author_Name', 'Main_Work_Image__stable_url', 'Places_Name__Map_Place_Name', 'Places_Name__Latitude', 'Places_Name__Longitude').filter(Q(ReasonForPlace='Photograph') | Q(ReasonForPlace='Drawing'))
    return render_to_csv_response(PlaceLocationDrawingPhoto)

def map_working_collection(request):
    PlaceLocationCollection = Works_Places.objects.values('WorkPlace_id', 'ReasonForPlace', 'Objects_Name__Work_Name', 'Objects_Name__Description', 'Objects_Name__Author__Author_Name', 'Objects_Name__AuthorAttributionCertainty', 'Objects_Name__Work_Creation_date', 'Main_Work_Image__Image_Name', 'Main_Work_Image__ImageAuthor_Name__Author_Name', 'Main_Work_Image__stable_url', 'Places_Name__Map_Place_Name', 'Places_Name__Latitude', 'Places_Name__Longitude').filter(ReasonForPlace='Collection')
