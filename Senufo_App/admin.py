...
class Work_RecordsAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': ('Database_Work_Name', 'Map_Work_Name', 'Work_Type', 'Author', 'AuthorAttributionCertainty', 'Author_Attribution_Certainty_Numeric', 'Description', 'Material', 'Dimensions', 'Publication_Information')
        }),
	('Date', {
    ...
    search_fields = ('Database_Work_Name', 'Map_Work_Name', 'Work_Type', 'Description', 'ResearchNotes1', 'ResearchNotes2', 'Material')
...
class PostsResource(resources.ModelResource):
    Object_Name = fields.Field(column_name='Objects_Name', attribute='Objects_Name', widget=ForeignKeyWidget(Work_Records, 'Database_Work_Name'))
...
class Works_PlacesAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': ('Objects_Name', 'Main_Work_Image', 'Places_Name', 'ReasonForPlace_Artist', 'ReasonForPlace_Drawing','ReasonForPlace_Photograph','ReasonForPlace_Acquisition','Place_Attribution_Certainty', 'Place_Attribution_Certainty_Numeric', 'Work_URL')
        }),
        ('Essay', {
